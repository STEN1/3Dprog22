...
#define LOG(text) Logger::getInstance()->logText(text)
#define LOG_HIGHLIGHT(text) Logger::getInstance()->logText(text, LogType::HIGHLIGHT)
#define LOG_WARNING(text) Logger::getInstance()->logText(text, LogType::WARNING)
#define LOG_ERROR(text) Logger::getInstance()->logText(text, LogType::REALERROR)
